...
there's [a sample project](https://github.com/goonr/gor_models_sample) generated by go-on-rails, you can view its godoc at godoc.org, more details to its [README](https://github.com/goonr/gor_models_sample).
